...
- Cursor, Claude Code, and/or Codex with Agent Skills discovery for the career toolkit;
- optional: the Offer Intelligence environment and `offer-intel` MCP from
  [`../offer-intelligence/README.md`](../offer-intelligence/README.md) for employer
  research.
...
1. Open `toolkits/career/` as the project in your client.
...
- [Job offer evaluation](../offer-intelligence/README.md) — pursue/decline decisions
